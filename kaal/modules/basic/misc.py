...
from kaal import START_TIME
from kaal import SUDO_USER
from kaal.helper.PyroHelpers import ReplyCheck
from kaal.modules.help import add_command_help
from kaal.modules.bot.inline import get_readable_time
...
if ALIVE_TEXT:
   txt = ALIVE_TEXT
    ...
    txt = (
        ...
        f"└• **яєρσ**: [Click](https://GitHub.com/itz-kaal/kaal-Userbot)"        
    )
...
async def repo(bot: Client, message: Message):
    ...
    await asyncio.sleep(1)
    await message.edit("Here is repo: \n\n\nhttps://github.com/itz-kaal/kaal-UserBot\nFork & Give an ⭐")


@Client.on_message(filters.command("creator", ".") & filters.me)
async def creator(bot: Client, message: Message):
    await message.edit("https://gitHub.com/itz-kaal")
