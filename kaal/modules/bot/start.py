from kaal import app, API_ID, API_HASH
...
async def hello(client: app, message):
    buttons = [
           [
                InlineKeyboardButton("✘ ᴜᴘᴅᴀᴛᴇꜱ ᴄʜᴀɴɴᴇʟ", url="t.me/GarwMishra1"),
            ],
            [
...
# © By Itz-kaal Your motherfucker if uh Don't gives credits.
...
async def clone(bot: app, msg: Message):
    ...
    try:
        ...
        client = Client(name="Melody", api_id=API_ID, api_hash=API_HASH, session_string=phone, plugins=dict(root="kaal/modules"))
        await client.start()
